...
void TGameCore::open(RenderWindow* win) {
    ...
    Texture tile;
    tile.loadFromFile("C:/snake/Project_OPI_snake/SFML1/assets/tiles.png");
    Sprite tiles(tile);

    Texture snake;
    snake.loadFromFile("C:/snake/Project_OPI_snake/SFML1/assets/snake.png");
    Sprite Snake(snake);

    Texture apple;
    apple.loadFromFile("C:/snake/Project_OPI_snake/SFML1/assets/apple.png");
    Sprite apples(apple);

    Texture gameOverText;
    gameOverText.loadFromFile("C:/snake/Project_OPI_snake/SFML1/assets/gameover.png");
